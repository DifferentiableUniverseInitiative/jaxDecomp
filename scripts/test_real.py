...
@jax.jit
def do_fft(x):
    return jaxdecomp.fft.prfft3d(x, pdims=pdims, global_shape=global_shape)
...
rec_array = jaxdecomp.fft.pirfft3d(karray, pdims=pdims, global_shape=global_shape)
...
if rank ==0:
    ...
    global_array = jnp.fft.rfftn(global_array)
