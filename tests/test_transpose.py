...
def test_x_y():
  """ Goes from an array of shape [z,y,x] # What we call an x pencil
    ...
    """
  array_transposed = jaxdecomp.transposeXtoY(array,
                                             pdims=pdims,
                                             global_shape=global_shape)
  global_array_transposed = global_array.transpose([2, 0, 1])

  assert_allclose(array_transposed,
                  global_array_transposed[:, rank * global_shape[0] //
                                          pdims[1]:(rank + 1) *
...
def test_y_z():
  ...
  array_transposed = jaxdecomp.transposeYtoZ(array_transposed,
                                             pdims=pdims,
                                             global_shape=global_shape)
...
def test_z_y():
  ...
  array_transposed = jaxdecomp.transposeYtoZ(array_transposed,
                                             pdims=pdims,
                                             global_shape=global_shape)
  array_transposed = jaxdecomp.transposeZtoY(array_transposed,
                                             pdims=pdims,
                                             global_shape=global_shape)
...
def test_y_x():
  ...
  array_transposed = jaxdecomp.transposeXtoY(array,
                                             pdims=pdims,
                                             global_shape=global_shape)
  array_transposed = jaxdecomp.transposeYtoX(array_transposed,
                                             pdims=pdims,
                                             global_shape=global_shape)
