...
def test_full_halo():
    padded_array = jnp.pad(array,[(global_shape[0]//pdims[1],global_shape[0]//pdims[1]),(0,0),(0,0)])
    ...
    assert_allclose(upper_slice, 
                    global_array[ next_rank*global_shape[0]//pdims[1]: (next_rank+1)*global_shape[0]//pdims[1]],
                    rtol=1e-10, atol=1e-10)
